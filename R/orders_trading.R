...
#'
#' @examples
#' td_order(symbol = "TSLA", "LIMIT", 10, price = 300, )
td_order <- function(symbol, orderType = "LIMIT", quantity = 0, price, instruction = "BUY") {

    #apiverb needs to contemplate "GET, PUT, POST, DELETE, OPTIONS, HEAD, PATCH"

    url <- 'https://api.tdameritrade.com/v1/accounts/489837238/orders' ## need to generalize this
